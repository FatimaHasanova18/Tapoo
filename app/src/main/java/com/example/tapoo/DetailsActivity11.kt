...
class DetailsActivity11 : AppCompatActivity() {
    private lateinit var binding: ActivityDetails11Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding =ActivityDetails11Binding.inflate(layoutInflater)
        setContentView(binding.root)
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT)
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding.apply {
            val intent = Intent(this@DetailsActivity11, DetailsActivity12::class.java)
